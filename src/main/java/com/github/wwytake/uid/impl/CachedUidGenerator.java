...
import com.github.wwytake.uid.buffer.BufferPaddingExecutor;
import com.github.wwytake.uid.buffer.RejectedPutBufferHandler;
import com.github.wwytake.uid.buffer.RejectedTakeBufferHandler;
import com.github.wwytake.uid.buffer.RingBuffer;
import com.github.wwytake.uid.exception.UidGenerateException;
...
import com.github.wwytake.uid.BitsAllocator;
 ...
 * <b>paddingFactor:</b> Represents a percent value of (0 - 100). When the count of rest available UIDs reach the
 ...
 * <b>scheduleInterval:</b> Padding buffer in a schedule, specify padding buffer interval, Unit as second
 * <b>rejectedPutBufferHandler:</b> Policy for rejected put buffer. Default as discard put request, just do logging
 * <b>rejectedTakeBufferHandler:</b> Policy for rejected take buffer. Default as throwing up an exception
 * 
 * @author yutianbao
 * @author tangyz
 */
...
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.initRingBuffer();
        LOGGER.debug("Initialized RingBuffer successfully.");
    }
    ...
    private void initRingBuffer() {
        ...
        LOGGER.debug("Initialized ring buffer size:{}, paddingFactor:{}", bufferSize, paddingFactor);
        ...
        LOGGER.debug("Initialized BufferPaddingExecutor. Using schdule:{}, interval:{}", usingSchedule, scheduleInterval);
